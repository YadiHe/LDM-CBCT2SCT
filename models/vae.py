...
def train_vae(
    ...
    for epoch in range(epochs):
        ...
        # 打印训练信息
        log_message = f"Epoch {epoch+1}, Train Loss: {train_loss:.4f}, Val Loss: {val_loss:.4f}, LR: {optimizer.param_groups[0]['lr']} "
        print(log_message)
        ...
        if val_loss < best_val_loss:
            ...
            save_message = f"✅ Saved new best vae at epoch {epoch+1} with val loss {val_loss:.4f}"
            print(save_message)
